    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            ...
            <form id="loginForm" method="post" action="login">
                ...
                <?php endif; ?>
                <div class="form-group"><label for="username">아이디</label><input class="form-control item" type="text" id="username" name="user_id" autocomplete="username"><label id="verify_user_id"></label></div>
                <div class="form-group"><label for="password">비밀번호</label><input class="form-control item" type="password" id="password" name="password" autocomplete="current-password"><label id="verify_password"></label></div>
