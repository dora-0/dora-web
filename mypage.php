            ...
            <div class="row">
                <div class="col">
                    ...
                    <form id="mypageForm" class="tab-content" method="post" action="mypage">
                        ...
                        <?php endif; ?>
                        <div class="form-group"><label for="username">아이디</label><input type="hidden" id="username" name="user_id" value="<?=$_SESSION["user_id"]?>"><br/><label id="user_id"><?=$_SESSION["user_id"]?></label></div>
